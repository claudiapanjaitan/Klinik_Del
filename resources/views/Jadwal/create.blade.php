...
@section('content')
<h1 class="h3 mb-2 text-gray-800 text-center">Form Jadwal</h1>
<div class="container">
    <div class="row mt-4">
            <div class="col-10">
                <form action="{{ route('jadwal.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="petugas" id="" class="form-control @error('petugas') is-invalid @enderror" placeholder="Masukkan Nama Petugas" autofocus value="{{ old('petugas', $data->petugas) }}">
                        @error('petugas')
                    ...
                    <div class="form-group">
                        <label>NIP</label>
                        <input type="text" name="NIP" id="" class="form-control @error('NIP') is-invalid @enderror" placeholder="Masukkan NIP Anda" value="{{ old('NIP', $data->NIP) }}">
                        @error('NIP')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group text-center">
                        <input type="submit" class="btn btn-primary mt-3" value="Tambah">
